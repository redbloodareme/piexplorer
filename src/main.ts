...
app.innerHTML = `
  ...
  <section id="createModal" class="creation-modal" aria-modal="true" role="dialog" aria-labelledby="createTitle" hidden>
...
function openModal(): void { modal.hidden = false; $('#setupFields').hidden = false; $('#calculationStatus').hidden = true; $('#start').hidden = false; $('#continue').hidden = true; $('#cancel').textContent = 'CANCEL'; $<HTMLInputElement>('#count').focus(); }
function closeModal(): void { modal.hidden = true; }
